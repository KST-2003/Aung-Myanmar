        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-search d-none d-lg-block">
            <div class="input-group">
              ...
              <input type="text" class="form-control dataTables_filter" id="datatable-filter" placeholder="Search now" aria-label="search" aria-describedby="search"  aria-controls="datatable">
            </div>
          </li>
        </ul>
